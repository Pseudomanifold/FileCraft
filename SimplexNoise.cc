...
float noise( float x, float y, float z )
{
  ...
  auto y1 = y0 - j1 + G3;
  auto z1 = z0 - k1 + G3;
  auto x2 = x0 - i2 + 2.f*G3;
  auto y2 = y0 - j2 + 2.f*G3;
  auto z2 = z0 - k2 + 2.f*G3;
  auto x3 = x0 - 1.f + 3.f*G3;
  auto y3 = y0 - 1.f + 3.f*G3;
  auto z3 = z0 - 1.f + 3.f*G3;
  ...
  auto t0 = 0.5f - x0*x0 - y0*y0 - z0*z0;
  if( t0 < 0 )
    n0 = 0.0;
  else
  {
  ...
  auto t1 = 0.5f - x1*x1 - y1*y1 - z1*z1;
  if( t1 < 0 )
    n1 = 0.0;
  else
  {
  ...
  auto t2 = 0.5f - x2*x2 - y2*y2 - z2*z2;
  if( t2 < 0 )
    n2 = 0.0;
  else
  {
